        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="max-w-xl text-center lg:text-left">
            ...
            <h1 className="mt-2 text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight">
              Desarrollador Full-Stack · IoT · Productos Propios
            </h1>
            <p className="mt-6 text-lg sm:text-xl text-muted-foreground">
              Construyo sistemas reales: desde APIs y apps móviles hasta
              firmware en ESP32 y herramientas open source. Con base en Chile,
              trabajando en soluciones que duran.
            </p>
