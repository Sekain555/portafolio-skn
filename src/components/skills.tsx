...
const skillsData = {
    ...
    categories: [
      ...
      },
      {
        ...
        skills: [
          ...
          {
            name: "Thunkable X",
            icon: <TbSquareLetterT className="h-5 w-5" />,
          },
        ],
      },
      {
      ...
      },
      {
        ...
        skills: [
          ...
          { name: "LVGL", icon: <SiLvgl className="h-5 w-5" /> },
          {
      ...
      {
        title: "Uso de herramientas con IA",
        icon: <GiArtificialIntelligence className="h-5 w-5 mr-2" />,
        skills: [
          { name: "ChatGPT", icon: <SiOpenai className="h-5 w-5" /> },
          { name: "Claude", icon: <SiClaude className="h-5 w-5" /> },
          { name: "DeepSeek", icon: <TbSquareLetterD className="h-5 w-5" /> },
          { name: "DeepWiki", icon: <TbSquareLetterD className="h-5 w-5" /> },
        ],
      },
    ],
  },
  complementary: {
    ...
    skills: [
      ...
      { name: "Firebase Console", icon: <SiFirebase className="h-5 w-5" /> },
      {
      ...
      { name: "Trello", icon: <FaTrello className="h-5 w-5" /> },
      {
        name: "Visual Studio 2022",
        icon: <DiVisualstudio className="h-5 w-5" />,
      },
  ...
  learning: {
    ...
    skills: [
      ...
      { name: "RAG/Chroma DB", icon: <SiGraphql className="h-5 w-5" /> },
